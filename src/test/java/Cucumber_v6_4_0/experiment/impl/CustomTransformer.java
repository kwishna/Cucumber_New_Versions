package Cucumber_v6_4_0.experiment.impl;
...
public class CustomTransformer implements TypeRegistryConfigurer {
	...
	public void configureTypeRegistry(TypeRegistry typeRegistry) {
		...
		//**************** DataTable****************
		typeRegistry.defineDataTableType(new DataTableType(Cucumber_v6_4_0.experiment.impl.Student.class, new TableEntryTransformer<Cucumber_v6_4_0.experiment.impl.Student>() {
			@Override
			public Cucumber_v6_4_0.experiment.impl.Student transform(Map<String, String> entry) {
				return Cucumber_v6_4_0.experiment.impl.Student.createStudent(entry.get("name"), entry.get("roll"));
			}
		}));

		typeRegistry.defineDataTableType(new DataTableType(Cucumber_v6_4_0.experiment.impl.Student.class, new TableCellTransformer<Cucumber_v6_4_0.experiment.impl.Student>() {
			@Override
			public Cucumber_v6_4_0.experiment.impl.Student transform(String cell) {
				return Cucumber_v6_4_0.experiment.impl.Student.createStudentOne(cell.toUpperCase());
			}
		}));
...
//		}));
		...
		typeRegistry.defineDataTableType(new DataTableType(Cucumber_v6_4_0.experiment.impl.Student.class, new TableTransformer<Cucumber_v6_4_0.experiment.impl.Student>() {
			@Override
			public Cucumber_v6_4_0.experiment.impl.Student transform(DataTable table) throws Throwable {
				List<Cucumber_v6_4_0.experiment.impl.Student> lects = table.asMaps().stream().map(m -> Cucumber_v6_4_0.experiment.impl.Student.createStudent(m.get("name"), m.get("roll")))
